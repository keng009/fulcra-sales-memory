...
3. Upload the skill: **Customize → Skills → + Create skill → Upload a skill**, pick `sales-memory.zip` (from the [releases page](https://github.com/keng009/fulcra-sales-memory/releases/latest)). Then open a new chat.
