...
const RAILS = [
  ...
  ["inbox glance (rule 8, browser observation)", "check my inboxes", [full]],
  ["inbox glance: never auto-logged", "never an ADR-0009 source", [full]],
  ["inbox glance: stop on warning", "browser-observation: paused", [full]],
